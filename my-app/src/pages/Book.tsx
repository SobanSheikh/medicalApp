...
const Book: React.FC = () => {
 useEffect(() => {
  ...
  return (
    ...
    <div className="flex flex-col w-full mt-20 px-20 gap-20 p-20 ">
      ...
      <div className="flex w-full justify-between items-center pr-32  ">
        <div className="flex   w-full bg-[#DAA06D]  h-[800px] border-2 border-amber-600 rounded-3xl ">
          <img src={bookImage3} alt="book 2"  className="object-cover rounded-3xl w-full" />
        </div>
        <div className="flex flex-col w-full  bg-[#DAA06D] p-8 gap-8 items-center border-2 border-white rounded-3xl">
          <div className="flex flex-col w-1/2 bg-pink-600 p-4 rounded-4xl">
            <span className="text-3xl font-semibold">She is me Now!</span>
            <hr />
          ...
          <span className="text-xl">
            t’s about reclaiming the pieces of yourself you lost along the way,
